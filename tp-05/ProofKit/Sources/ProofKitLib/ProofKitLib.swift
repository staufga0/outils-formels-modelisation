    ...
    public var dnf: Formula {
        ...
        case .conjunction(let b, let c):
          ...
          case .disjunction(let b1, let b2):
              return (b1 && c.dnf).dnf || (b2 && c.dnf).dnf
          default :
            switch c.dnf {
            case .disjunction(let c1, let c2):
                return (b.dnf && c1).dnf || (b.dnf && c2).dnf
            default:
                return b.dnf && c.dnf
            }
          }
    ...
    public var cnf: Formula {
      ...
      case .disjunction(let b, let c):
        ...
        case .conjunction(let b1, let b2):
            return (b1 || c.cnf).cnf && (b2 || c.cnf).cnf
        default :
          switch c.cnf {
          case .conjunction(let c1, let c2):
              return (b.cnf || c1).cnf && (b.cnf || c2).cnf
          default:
              return b.cnf || c.cnf
          }
        }
